...
### Fish Trade Value: Separating new_commodity for Import
...
g = sns.FacetGrid(
    df_import,
    row='new_commodity',       # separate rows for each commodity
    col='region',              # separate columns for each region
    aspect=2,
    height=2.0,
    despine=True,
    sharey=True,               # same y-axis across rows
    sharex=True                # same x-axis (year) across columns
)

g.map_dataframe(sns.lineplot, 'year', 'trade', ci=None)

# Titles
g.set_titles(row_template="{row_name}", col_template="{col_name} - Import")

g.tight_layout()
plt.show()

# Save figure with dpi
g.savefig("trade_specie_region_flow_import_separated.png", dpi=1000, bbox_inches="tight")

# Download file (Colab)
from google.colab import files
files.download("trade_specie_region_flow_import_separated.png")
...
### Fish Trade Value: Separating new_commodity for Export
...
# Subset for Export
df_import = rel_col[rel_col["flow"] == "Export"]
...
# Titles
g.set_titles(row_template="{row_name}", col_template="{col_name} - Export")

g.tight_layout()
plt.show()

# Save figure with dpi
g.savefig("trade_specie_region_flow_export_separated.png", dpi=1000, bbox_inches="tight")

# Download file (Colab)
from google.colab import files
files.download("trade_specie_region_flow_export_separated.png")
...
### Fish Trade Value: Separating new_commodity for Re-Export
...
# Subset for Re-Export
df_import = rel_col[rel_col["flow"] == "Re-Export"]
...
# Titles
g.set_titles(row_template="{row_name}", col_template="{col_name} - Re-Export")

g.tight_layout()
plt.show()

# Save figure with dpi
g.savefig("trade_specie_region_flow_re_export_separated.png", dpi=1000, bbox_inches="tight")

# Download file (Colab)
from google.colab import files
files.download("trade_specie_region_flow_re_export_separated.png")
...
"""Market Flow Trade-Import, Export, and Re-Export"""

## Market Flow Trade: Separating trade flow for Import, Export, and Re-Export
...
g = sns.FacetGrid(
    rel_col,
    row='flow',                # Separate rows for Import, Export, Re-Export
    col='new_commodity',       # Separate columns for each commodity
    aspect=2,
    height=2.0,
    despine=True
)
...
g.savefig("trade_specie_flow_SSA_import_export_re_export.png", dpi=1000, bbox_inches="tight")

# Download file (Colab)
from google.colab import files
files.download("trade_specie_flow_SSA_import_export_re_export.png")
...
### Fish Quantity: Separating new_commodity for Import
...
# Save figure with dpi
g.savefig("qty_specie_region_flow_import_separated.png", dpi=1000, bbox_inches="tight")

# Download file (Colab)
from google.colab import files
files.download("qty_specie_region_flow_import_separated.png")
...
### Fish Quantity: Separating new_commodity for Export
...
# Save figure with dpi
g.savefig("qty_specie_region_flow_export_separated.png", dpi=1000, bbox_inches="tight")

# Download file (Colab)
from google.colab import files
files.download("qty_specie_region_flow_export_separated.png")
...
# Subset for Re-Export
df_reexport = rel_col2[rel_col2["flow"] == "Re-Export"]
...
# Titles: row = commodity, col = region
g.set_titles(row_template="{row_name}", col_template="{col_name} - Re-Export")
...
# Save figure with dpi
g.savefig("qty_specie_region_flow_re_export_separated.png", dpi=1000, bbox_inches="tight")

# Download file (Colab)
from google.colab import files
files.download("qty_specie_region_flow_re_export_separated.png")
...
## Market Flow Quantity: Separating quantity flow for Import, Export, and Re-Export
...
# Save figure with high dpi
g.savefig("qty_specie_flow_SSA_import_export_re_export.png", dpi=1000, bbox_inches="tight")

# Download file (Colab)
from google.colab import files
files.download("qty_specie_flow_SSA_import_export_re_export.png")
